...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na PNDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a PNDesk ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate PNDesk na sustav."),
        ...
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, PNDesk-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, PNDesk-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti PNDesk-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [PNDesk Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep PNDesk background service", "Zadrži PNDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje PNDesk aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti PNDesku dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti PNDesku \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog PNDeska."),
        ...
        ("verify_PNDesk_password_tip", "Provjera lozinke za PNDesk"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete PNDesk, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_PNDesk_server_pro_to_{}_tip", "Ažurirajte PNDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti PNDesk da pravilno radi kao upravljana strana."),
