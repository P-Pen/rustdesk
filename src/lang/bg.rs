...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", ""),
        ("Established", ""),
        ("connecting_status", "Свързване с PNDesk мрежата..."),
        ("Enable service", ""),
        ("Start service", ""),
        ("Service is running", ""),
        ...
        ("install_tip", "Поради UAC, PNDesk в някои случай не може да работи правилно като отдалечена достъп. За да заобиколите UAC, моля, щракнете върху бутона по-долу, за да инсталирате PNDesk в системата."),
        ("Click to upgrade", ""),
        ("Click to download", ""),
        ("Click to update", ""),
        ("Configure", ""),
        ("config_acc", "За да управлявате вашия работен плот дистанционно, трябва да предоставите на PNDesk разрешения \"Достъпност\"."),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или докосване, трябва да разрешите на PNDesk да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница с системни настройки, намерете и въведете [Installed Services], включете услугата [PNDesk Input]."),
        ...
        ("Turned off", ""),
        ("Language", ""),
        ("Keep PNDesk background service", ""),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението PNDesk, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ("Start on boot", ""),
        ...
        ("config_input", "За да контролирате отдалечен работен плот с клавиатура, трябва да предоставите на PNDesk разрешения \"Input Monitoring\"."),
        ("config_microphone", "За да говорите дистанционно, трябва да предоставите на PNDesk разрешения \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да щракне върху OK в прозореца на UAC при стартиранят PNDesk."),
        ...
        ("verify_PNDesk_password_tip", "Проверете PNDesk паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате PNDesk и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_PNDesk_server_pro_to_{}_tip", "Моля обновете PNDesk Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на PNDesk да работи правилно като контролирана страна."),
        ("Change view", ""),
        ("Big tiles", ""),
        ("Small tiles", ""),
        ("List", ""),
