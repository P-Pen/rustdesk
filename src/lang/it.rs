...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete PNDesk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), PNDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare PNDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a PNDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a PNDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a PNDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [PNDesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep PNDesk background service", "Mantieni il servizio di PNDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione PNDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a PNDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a PNDesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di PNDesk."),
        ...
        ("verify_PNDesk_password_tip", "Conferma password PNDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare PNDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_PNDesk_server_pro_to_{}_tip", "Aggiorna PNDesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di PNDesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da PNDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti la connessione solo se la finestra PNDesk è aperta"),
