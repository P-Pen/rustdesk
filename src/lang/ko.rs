...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비"),
        ("Established", "연결됨"),
        ("connecting_status", "PNDesk 네트워크로 연결중입니다..."),
        ...
        ("OS Password", "OS 비밀번호"),
        ("install_tip", "UAC로 인해, PNDesk가 원격지일 때 일부 기능이 동작하지 않을 수 있습니다. UAC 문제를 방지하려면, 아래 버튼을 클릭하여 PNDesk를 시스템에 설치해주세요."),
        ("Click to upgrade", "업그레이드"),
        ("Click to download", "다운로드"),
        ("Click to update", "업데이트"),
        ("Configure", "구성"),
        ("config_acc", "내 데스크탑을 원격제어하기 전에, PNDesk에게 \"Accessibility (접근성)\" 권한을 부여해야 합니다."),
        ("config_screen", "내 데스크탑을 원격제어하기 전에, PNDesk에게 \"Screen Recording (화면 녹화)\" 권한을 부여해야 합니다."),
        ("Installing ...", "설치중 ..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("android_input_permission_tip1", "원격지로서 마우스나 터치를 통해 Android 장치를 제어하려면 PNDesk에서 \"Accessibility (접근성)\" 서비스 사용을 허용해야 합니다."),
        ("android_input_permission_tip2", "시스템 설정 페이지로 이동하여 [설치된 서비스]에서 [PNDesk Input] 서비스를 켜십시오."),
        ...
        ("Turned off", "종료됨"),
        ("Language", "언어"),
        ("Keep PNDesk background service", "PNDesk 백그라운드 서비스로 유지하기"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시하기"),
        ("android_open_battery_optimizations_tip", "해당 기능을 비활성화하려면 PNDesk 응용 프로그램 설정 페이지로 이동하여 [배터리]에서 [제한 없음] 선택을 해제하십시오."),
        ...
        ("config_input", "키보드를 통해 원격 데스크톱을 제어할 수 있으려면 PNDesk의 \"입력 모니터링\" 권한을 부여해 주세요"),
        ("config_microphone", "마이크를 통한 오디오 전송을 지원하려면 PNDesk에 \"녹음\" 권한을 부여해 주세요"),
        ...
        ("still_click_uac_tip", "통제된 사용자는 여전히 PNDesk를 실행하는 UAC 창에서 확인을 클릭해야 합니다"),
        ...
        ("verify_PNDesk_password_tip", "PNDesk 비밀번호 확인"),
        ...
        ("scam_text1", "모르는 사람과 통화 중이고 그들이 PNDesk를 사용하여 서비스를 시작하라고 요청하는 경우, 계속하지 말고 즉시 전화를 끊으세요"),
        ...
        ("upgrade_PNDesk_server_pro_to_{}_tip", "PNDesk Server Pro를 {} 버전 이상으로 업그레이드하십시오!"),
        ...
        ("selinux_tip", "SELinux를 활성화하면 PNDesk가 호스트로 제대로 실행되지 않을 수 있습니다"),
        ("Change view", "보기 변경"),
        ("Big tiles", "큰 타일"),
        ("Small tiles", "작은 타일"),
        ("List", "리스트"),
