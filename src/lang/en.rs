...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the PNDesk network..."),
        ...
        ("install_tip", "Due to UAC, PNDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install PNDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant PNDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant PNDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow PNDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [PNDesk Input] service."),
        ...
        ("doc_mac_permission", "https://PNDesk.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next PNDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant PNDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant PNDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running PNDesk."),
        ...
        ("verify_PNDesk_password_tip", "Verify PNDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use PNDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_PNDesk_server_pro_to_{}_tip", "Please upgrade PNDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://PNDesk.com/docs/en/client/linux/#x11-required"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent PNDesk from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by PNDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if PNDesk window is open"),
