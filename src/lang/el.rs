...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο PNDesk..."),
        ...
        ("install_tip", "Λόγω UAC, το PNDesk ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το PNDesk στο σύστημα"),
        ("Click to upgrade", "Πιέστε για αναβάθμιση"),
        ("Click to download", "Πιέστε για λήψη"),
        ("Click to update", "Πιέστε για ενημέρωση"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για τον απομακρυσμένο έλεγχο του υπολογιστή σας, πρέπει να εκχωρήσετε δικαιώματα πρόσβασης στο PNDesk."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στον υπολογιστή σας, πρέπει να εκχωρήσετε το δικαίωμα PNDesk \"Screen Capture\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο PNDesk να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλώ μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος PNDesk]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep PNDesk background service", "Εκτέλεση του PNDesk στο παρασκήνιο"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με πληκτρολόγιο, πρέπει να εκχωρήσετε δικαιώματα στο PNDesk"),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο OK στο παράθυρο UAC όπου εκτελείται το PNDesk."),
        ...
        ("verify_PNDesk_password_tip", "Επιβεβαιώστε τον κωδικό του PNDesk"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το PNDesk, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("upgrade_PNDesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον PNDesk Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Έχετε ενεργοποιημένο το SELinux, το οποίο πιθανόν εμποδίζει την ορθή λειτουργία του PNDesk."),
