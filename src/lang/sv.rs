...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till PNDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte PNDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera PNDesk på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge PNDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge PNDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [PNDesk Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep PNDesk background service", "Behåll PNDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa PNDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
