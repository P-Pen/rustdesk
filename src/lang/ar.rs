...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة PNDesk..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. PNDesk قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت PNDesk في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Click to download", "اضغط للتنزيل"),
        ("Click to update", "ضغط للتحديث"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح PNDesk اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح PNDesk اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ PNDesk باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [PNDesk Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep PNDesk background service", "ابق خدمة PNDesk تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق PNDesk, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من PNDesk اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح PNDesk اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في PNDesk الذي يعمل."),
        ...
        ("verify_PNDesk_password_tip", "تحقق من كلمة مرور PNDesk"),
