...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, PNDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, PNDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için PNDesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için PNDesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, PNDesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [PNDesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep PNDesk background service", "PNDesk arka plan hizmetini sürdürün"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için PNDesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için PNDesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan PNDesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_PNDesk_password_tip", "PNDesk parolasını doğrulayın"),
