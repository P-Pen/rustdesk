...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használata során. A megfelelő működés érdekében, kérem telepítse a PNDesk alkalmazást a számítógépre."),
        ...
        ("Configure", "Beállítás"),
        ("config_acc", "A távoli vezérléshez a PNDesk-nek \"Kisegítő lehetőség\" engedélyre van szüksége"),
        ...
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [PNDesk Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep PNDesk background service", "PNDesk futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívűl hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a PNDesk alkalmazás beállítási oldalára, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ("Start on boot", ""),
        ...
        ("Show PNDesk", "A PNDesk megjelenítése"),
